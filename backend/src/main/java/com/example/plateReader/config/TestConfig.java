...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Person p4 = new Person("PUM5050", "Regina Silva", "45018650", "376.019.188-00", LocalDate.parse("2002-05-14"));
        ...
        Crime c5 = new Crime("Violência", LocalDateTime.parse("2017-03-11T10:30:00"), "Violência Doméstica");
